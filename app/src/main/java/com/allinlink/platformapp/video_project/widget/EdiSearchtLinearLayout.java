...
public class EdiSearchtLinearLayout extends LinearLayout implements View.OnFocusChangeListener {
    EditText editText;
    ImageView ivDelete;
    private String msg = "";
    private String text = "";

    public EdiSearchtLinearLayout(Context context) {
        super(context);
    }

    public EdiSearchtLinearLayout(Context context, AttributeSet set) {
        super(context, set);
    }
