...
//
//        EaseUIInitializer.getInstance().isVoiceCalling = true;
//		callType = 0;
//
...
//                Log.d("EMCallManager dawn", "onCallStateChanged:" + callState);
//                switch (callState) {
//
//                case CONNECTING:
...
//        EaseUIInitializer.getInstance().isVoiceCalling = false;
//        stopMonitor();
//        super.onDestroy();
//    }
//
