...
import com.example.android_supervisor.ui.adapter.EventTjItemAdapter;
 ...
 * @author dw
 */
public class HistoryTjFragment extends SearchListFragment {
    private EventTjItemAdapter adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new EventTjItemAdapter(getContext());
        setAdapter(adapter);
    ...
    private void fetchData(final boolean refresh, final boolean loadMore) {
        ...
        Observable<Response<List<EventRes>>> observable = questionService.listVerifyCheckAndTheProduct(queryBody);
