...
class ClientInfo//bo
{
    public static String initXInfo(Context context, boolean paramBoolean) {
        try {
            ...
            byte[] arrayOfByte1 = FileUtil.gZip((byte[]) clientBytes1);
...
//    public static String encrypt(byte byteContent[], String password) throws InvalidKeyException,
//            IOException, InvalidKeySpecException, NoSuchPaddingException, NoSuchAlgorithmException,
//            IllegalBlockSizeException, BadPaddingException, CertificateException, NoSuchProviderException {
...
//            sb.append("\"sim\":\"").append(str).append("\",\"username\":\"")
//                    .append(sdkInfo.username).append("\",\"sdkver\":\"").append(sdkInfo.version)
//                    .append("\",\"product\":\"").append(sdkInfo.product).append("\",\"child\":\"")
//                    .append(sdkInfo.d()).append("\",\"wnt\":\"")
//                    .append(DeviceInfo.getNetworkType(context)).append("\",\"netype\":\"")
//                    .append(DeviceInfo.getNetworkOperatorName(context)).append("\",\"mnc\":\"")
//                    .append(DeviceInfo.b(context)).append("\",\"nct\":\"")
//                    .append(DeviceInfo.getNetType(context)).append("\"");
//        } catch (Throwable throwable) {
