...
class XGPoiSearchServerHandler extends
        JsonResultHandler<QueryInternal, XGPoiResult> {
    ...
    public XGPoiSearchServerHandler(Context context, QueryInternal qInternal,
...
//
    ...
    protected String getUrl() {
        return  "http://10.16.68.120:5071/gisserver/service/poi_wfst/wfs?request=GETFEATURE&typeName=poi_wfst:poi&cql_filter=poiname like '%25机场%25'&outputFormat=application/json";
    }
    ...
    @Override
    protected XGPoiResult parseJson(JSONObject obj) throws UnistrongException {
        XGPoiResult pr = null;
//        processServerErrorcode(getJsonStringValue(obj, "status", ""),
//                getJsonStringValue(obj, "message", ""));
        // 解析结果
        pr = new XGPoiJsonParser().Poiparser(obj);
        return pr;
    }
}
