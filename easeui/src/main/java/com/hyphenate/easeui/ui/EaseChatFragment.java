...
//            R.drawable.em_chat_file_selector,R.drawable.em_chat_voice_call_selector,R.drawable.em_chat_video_selector
    };
    protected int[] itemIds = { ITEM_TAKE_PICTURE, ITEM_PICTURE
//            , ITEM_VIDEO,ITEM_FILE,ITEM_VOICE_CALL,ITEM_VIDEO_CALL
    };
