...
//     * @return GeojsonMarkerOptions 对象。
//     */
//    public GeojsonMarkerOptions icons(ArrayList<BitmapDescriptor> icons)
//    {
//        this.icons = icons;
//        return this;
//    }
...
//     * @return GeojsonMarkerOptions 对象。
//     */
//    public GeojsonMarkerOptions period(int period)
//    {
//        if (period <= 1) {
//            this.period = 1;
//        } else {
...
//     */
//    public GeojsonMarkerOptions perspective(boolean perspective)
//    {
...
//     */
//    public GeojsonMarkerOptions setAddByAnimation(boolean addByAnimation) {
//        this.isAddByAnimation = addByAnimation;
//        return this;
//    }

    public static final Creator<GeojsonMarkerOptions> CREATOR = new GeojsonMarkerOptionsCreator();
     ...
     */
    public GeojsonMarkerOptions setFlat(boolean flat)
    {
        this.flat = flat;
        return this;
    }
     ...
     * @return MarkerOptions对象。
     */
    public GeojsonMarkerOptions icon(BitmapDescriptor icon)
    {
        initBitmapArray();
        this.icons.clear();
        this.icons.add(icon);
     ...
     */
    public GeojsonMarkerOptions anchor(float u, float v)
    {
        this.anchorU = u;
        this.anchorV = v;
        return this;
...
//     * @return MarkerOptions对象。
//     */
//    public GeojsonMarkerOptions setInfoWindowOffset(int offsetX, int offsetY)
//    {
...
//     */
//    public GeojsonMarkerOptions title(String title)
//    {
//        this.title = title;
//        return this;
//    }
...
//     */
//    public GeojsonMarkerOptions snippet(String snippet)
//    {
...
//     */
//    public GeojsonMarkerOptions draggable(boolean draggable)
//    {
...
//     */
//    public GeojsonMarkerOptions visible(boolean visible)
//    {
...
//     * @return GeojsonMarkerOptions 对象。
//     */
//    public GeojsonMarkerOptions setGps(boolean isGps)
//    {
//        this.gps = isGps;
//        return this;
//    }
...
//    }
     ...
     * @return MarkerOptions对象。
     */
    public GeojsonMarkerOptions zIndex(float zIndex)
    {
        this.zIndex = zIndex;
        return this;
    }
...
//        paramParcel.writeInt(this.offsetY);
        paramParcel.writeBooleanArray(new boolean[] { this.flat});
