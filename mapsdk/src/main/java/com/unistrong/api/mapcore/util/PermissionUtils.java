...
//     *
//     * @param activity
//     * @param requestCode request code, e.g. if you need request CAMERA permission,
//     *                    parameters is PermissionUtils.CODE_CAMERA
//     */
...
//     * @return
//     */
//    public static boolean hasPermission(final Context activity, String requestPermission){
...
//        } catch (RuntimeException e) {
////            Log.e(TAG, "RuntimeException:" + e.getMessage());
//            SDKLogHandler.exception(e, "Util", "hasPermission");
//            e.printStackTrace();
////            return;
//        } finally {
...
//     * @return
//     */
//    public static boolean hasSDRWPermission(final Context activity){
//        return hasPermission(activity, PERMISSION_READ_EXTERNAL_STORAGE)
//                && hasPermission(activity, PERMISSION_WRITE_EXTERNAL_STORAGE);
//    }
//
//    /**
//     * 检测是否拥有gps权限
...
//     * @return
//     */
//    public static boolean hasGpsPermission(final Context activity){
//        return hasPermission(activity, PERMISSION_ACCESS_FINE_LOCATION);
//    }
//
...
////    }
//
//    private static Dialog showMessageOKCancel(final Activity context, String message,
...
//
//    // 打开应用的权限设置界面
//    public static Dialog openSettingActivity(final Activity activity, String message) {
//
//        final Dialog dialog = showMessageOKCancel(activity, message, new DialogInterface.OnClickListener() {
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
